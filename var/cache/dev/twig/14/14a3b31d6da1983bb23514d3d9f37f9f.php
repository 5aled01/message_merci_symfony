...
class __TwigTemplate_f0c2bb193db08470a545d01a8189c31d extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "reason", [], "any", false, false, false, 13), 'row');
        echo "
...
";
    ...
    {
        return array (  109 => 15,  104 => 13,  100 => 12,  96 => 11,  93 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "dashboard/edit.html.twig", "/Users/khaledihitt/Downloads/symfony-6-login-register-main/templates/dashboard/edit.html.twig");
    }
}
